...
function UserPage() {
  ...
  return (
    <div className="grid grid-cols-2">
      ...
      <div className='col-span-1 m-auto border text-center bg-purple-400 w-96 p-12 space-y-8'>
        ...
        <button onClick={playAgain} className='btn'>Play</button>
      </div>

      {/* their history, last ten songs listened to */}
      <div className="relative overflow-x-auto justify-self-center cols-span-1">
